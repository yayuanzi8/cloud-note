...
public enum StatusCode implements RestStatus {
    ...
    EMAIL_CODE_NOT_FOUND(42006, "验证码不存在"),

    EMAIL_CODE_ERROR(42007, "验证码错误"),

    UN_LENGTH_ERROR(42008, "用户名长度错误"),

    PWD_LENGTH_ERROR(42009, "密码长度错误"),

    EMAIL_EXISTS(42010, "邮箱已被使用"),

    AUTH_FAIL(42011, "认证失败"),

    PSW_ERROR(42012, "密码错误"),
